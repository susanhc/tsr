...
if __name__ == '__main__':
    #pathdir='./images/test'
    pathdir='/data2/ggp/MNist/flower/DF/images/test/'
    dir=os.listdir(pathdir)
    for path in dir:
        img=os.path.join(pathdir,path)
        print(img)
        m = deHaze(cv2.imread(img)/255.0)*255
        cv2.imwrite('/data2/ggp/MNist/flower/DF/defog_images/test/%s'%(path), m)
        cv2.waitKey(0)